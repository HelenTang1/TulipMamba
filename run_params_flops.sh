...
args=(
    ...
    --warmup_epochs 60
    # Model parameters
    --model_select tulip_base_mamba_crsmamba
    --pixel_shuffle # improve
    --circular_padding # improve
    --log_transform # improve
    --patch_unmerging # improve
    ...
    # --wandb_disabled
    --project_name experiment_kitti
    --output_dir ./experiment/kitti/tulip_base_mamba_crsmamba
...
args=(
    ...
    # --wandb_disabled
    --project_name experiment_kitti
    --output_dir ./experiment/kitti/tulip_base_mamba
    --log_dir ./experiment/kitti/tulip_base_mamba
    --img_size_low_res 16 2048
    --img_size_high_res 64 2048
    --window_size 2 8
    --patch_size 1 4
